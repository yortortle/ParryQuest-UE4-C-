...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_BunnyTrigger_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_BunnyTrigger;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABunnyHorde_Statics::NewProp_BunnyTrigger_MetaData[] = {
		{ "Category", "BunnyHorde" },
		{ "ModuleRelativePath", "BunnyHorde.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABunnyHorde_Statics::NewProp_BunnyTrigger = { "BunnyTrigger", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABunnyHorde, BunnyTrigger), Z_Construct_UClass_APaperCharacter_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABunnyHorde_Statics::NewProp_BunnyTrigger_MetaData, ARRAY_COUNT(Z_Construct_UClass_ABunnyHorde_Statics::NewProp_BunnyTrigger_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABunnyHorde_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABunnyHorde_Statics::NewProp_BunnyTrigger,
	...
	IMPLEMENT_CLASS(ABunnyHorde, 3863844234);
